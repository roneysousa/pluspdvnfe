...
type
  ...
  private
    ...
    Function VerificarOutlook(): Boolean;
...
var
  ...
  aCaminho1, aCaminho2, aCaminho3, NomeDoLista : String;
...
begin
    ...
    //
    aCaminho1 := 'C:\Arquivos de programas\Microsoft Office\Office12\OUTLOOK.EXE';
    aCaminho2 := 'C:\Program Files\Microsoft Office\Office12\OUTLOOK.EXE';
    aCaminho3 := 'C:\Program Files (x86)\Microsoft Office\Office12\OUTLOOK.EXE';
end;
...
Var
  ...
  M_CDTIPO, M_CDSITU, M_CDNATU : String;
...
begin
     ...
     M_TEXTO := M_TEXTO +' nf.id_empresa, nf.id_cliente, nf.id_fornecedor, nf.tipo_emis, nf.natureza_operacao, ';
     ...
     M_TEXTO := M_TEXTO +' Where (nf.id_empresa = '+QuotedStr(InttoStr(idLoja))+') and (nf.data_hora_emissao >= :pDTINIC) and (nf.data_hora_emissao <= :pDTFINA) ';
...
function TFrmGerenciarNotas.VerificarOutlook: Boolean;
Var
   aChou : Boolean;
begin
     aChou := True;
     //
     if not FileExists(aCaminho1) Then
     begin
         aChou := False;
         if not FileExists(aCaminho2) Then
          begin
              aChou := False;
              if not FileExists(aCaminho3) Then
                 aChou   := False
              Else
                 aChou := True;
          End
