...
begin   
    ...
    ACBrNFeDANFERaveCB1.QuebraLinhaEmDetalhamentoEspecifico := False;
    //
    ...
    //
    CarregarAliquotaPartilhaICMS(cdsListaAliquotaPart);
end;
...
Var
   fValorDescontoItem , fValor, fValorDiferenca, fSaldoOutras, fSubTotalItem : Double;
   iQuantItens : Integer;
begin
     With aCDS do
      begin
           ...
           begin                             
                ...
                fValor := uFuncoes.Arredondar(fValorDescontoItem*iQuantItens, 2) ;
                fValorDiferenca := 0;
                fSaldoOutras     := 0;
                fSubTotalItem    := 0;
                //
                ...
                While not (Eof) do
                 begin
                      ...
                      begin
                           Edit;
                           fSubTotalItem := uFuncoes.Arredondar(FieldByName('CDS_VLUNITARIO').AsFloat * FieldByName('CDS_QTDECOM').AsFloat, udmDados.iCasasDecimais);
                           If (RecNo = iQuantItens) Then
                            begin
                               FieldByName('CDS_VLDESCONTO').AsFloat := fValor;
                               //
                               FieldByName('CDS_PEDESC').asFloat     := uFuncoes.ConverterValorPercentual(fSubTotalItem, fValor);
                               //
                               fValor := 0;
                            End
                           Else
                           begin
                               ...
                               FieldByName('CDS_PEDESC').asFloat     := uFuncoes.ConverterValorPercentual(fSubTotalItem, fValorDescontoItem);
                               //
     ...
     If (cdsItemsNotaFiscalCDS_VLUNITARIO.AsFloat > 0)
        ...
        begin
           fSubTotal :=  uFuncoes.Arredondar(
              ...
              + cdsItemsNotaFiscalCDS_VLOUTRASDESPESAS.asFloat
              + cdsItemsNotaFiscalCDS_VLFRETE.asfloat)
                                ...
                                W_VLALIQ  := 0;
                                 ...
                                 With Det.Add do
                                  begin
                                       ...
                                       //
                                       FSubTotal    := uFuncoes.Arredondar((Prod.vProd + cdsNotaFiscalItensvalor_frete.asFloat + cdsNotaFiscalItensvalor_outrasdespesas.asFloat ) - Prod.vDesc,2);
                                       // Alteração
                                             ...
                                             begin
                                                ...
                                                if (dmDados.GetVerificaProdutoMedicamento(cdsNotaFiscalItensid_produto.asinteger)) Then
                                                 begin
                                                   ...
                                                   //
                                                   FValorPMC := dmDados.GerPMCProduto(cdsNotaFiscalItensid_produto.asinteger);
                                                          ...
                                                          begin
                                                               ...
                                                               begin
                                                                    ...
                                                                    begin
                                                                         ...
                                                                         COFINS.vBC     := RoundTo(FSubTotal,-2);
...
begin
     ...
     texto := texto + ' and (emitente_cnpj =' +QuotedStr(aCNPJEmitente)+') ';
     //
     QrAux := TSQLquery.Create(nil);
     with QrAux do
       try
...
procedure TdmNFe.CarregarAliquotaPartilhaICMS(aCdsLista: TClientDataSet);
begin
    dmDados.RefreshCDS(aCdsLista);
    aCdsLista.EmptyDataSet;
    With aCdsLista do
     begin
          //  2016
          Append;
          FieldByname('CDS_ANO').AsInteger := 2016;
          FieldByname('CDS_ALIQUOTA_DESTINO').AsFloat   := 40;
          Post;
          //  2017
          Append;
          FieldByname('CDS_ANO').AsInteger := 2017;
          FieldByname('CDS_ALIQUOTA_DESTINO').AsFloat   := 60;
          Post;
          //  2018
          Append;
          FieldByname('CDS_ANO').AsInteger := 2018;
          FieldByname('CDS_ALIQUOTA_DESTINO').AsFloat   := 80;
          Post;
          //  2019
          Append;
          FieldByname('CDS_ANO').AsInteger := 2019;
          FieldByname('CDS_ALIQUOTA_DESTINO').AsFloat   := 100;
          Post;
     End; //   With aCdsLista do
end;

function TdmNFe.GetAliquotaDestinatario(aDataAtual: TDatetime): Double;
Var
     Dia, Mes, Ano : Word;
begin
     DecodeDate (aDataAtual, Ano, Mes, Dia);
     if (cdsListaAliquotaPart.Locate('CDS_ANO',Ano,[])) Then
