...
begin
    ...
    texto := 'Select Max(numero_nota_fiscal) as total from nota_fiscal where (id_empresa = :pemitente) and (indicador_do_emitente = '+QuotedStr('0')+') and (situacao <> 99) and (modelo = 8) ';
    QrAux := TSqlquery.Create(nil);
    with QrAux do
     try
          SQLConnection := sqlConexao;
