...
begin
     if uFuncoes.Empty(edtDesconto.Text) Then
      begin
           Application.MessageBox('Digite o valor do desconto.','ATENÇÃO',
...
begin
     ...
     begin
          ...
          Else
          begin
               Application.MessageBox('Valor do desconto não pode ser igual ou superior ao do Sub-Total!!!','ATENÇÃO',
                     MB_OK+MB_ICONEXCLAMATION+MB_APPLMODAL);
               edtDesconto.SetFocus;
          End;
     End;
