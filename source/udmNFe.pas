...
uses
  SysUtils, Classes, ACBrNFeDANFERaveCB, ACBrNFeDANFEClass, Forms,
  ACBrNFeDANFERave, ACBrNFe, FMTBcd, DB, SqlExpr, DBClient, Provider, Math,
  Windows, Messages, Variants, XMLDoc, XMLIntf, xmldom,
  msxmldom,  ACBrNFeUtil, pcnConversao, Dialogs, ExtCtrls, StdCtrls,
...
begin   
    ...
    DirNFe := ExtractFilePath( Application.ExeName )+'RetornoNfe';
...
begin
     ...
     //
     ACBrNFeDANFERaveCB1.PathPDF :=  ACBrNFeDANFERave1.PathPDF;
     //
     ACBrNFeDANFERave1.MostrarPreview := true;
     ACBrNFeDANFERave1.MostrarStatus  := true;
     //
     ACBrNFeDANFERave1.MostrarPreview := true;
     ACBrNFeDANFERave1.MostrarStatus := true;  
     //
     ACBrNFe1.Configuracoes.Geral.PathSalvar := ExtractFilePath( Application.ExeName )+'XML\';
...
begin
      ...
      Try
          With ACBrNFe1.NotasFiscais.Add.NFe do
               ...
               begin
                    ...
                    begin
                         ...
                         begin
                              With Ide.NFref.Add do
                              begin
                                RefNF.cUF    := NotaUtil.UFtoCUF(cdsListaNT_RefCDR_UF.AsString);
           ...
           //
           ACBrNFe1.NotasFiscais.Clear;
           ACBrNFe1.NotasFiscais.LoadFromFile(aArquivo);
           If (aSoImprimir = 'N') Then
